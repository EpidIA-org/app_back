...
from libs.connectors.storage_connector import StorageConnector
...
if __name__ == "__main__":
    connect_str = os.getenv("STORAGE_CREDENTIALS")
    abc = AzureBlobConnector(credentials=connect_str, storage_name="covidappingestion")
